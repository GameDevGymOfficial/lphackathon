...
public class MoveLogic : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        { 
            movePoints[0].GetComponent<RowHolder>().RowCode, 
            movePoints[1].GetComponent<RowHolder>().RowCode, 
            movePoints[2].GetComponent<RowHolder>().RowCode, 
            movePoints[3].GetComponent<RowHolder>().RowCode 
        };
    }
